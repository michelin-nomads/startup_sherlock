...
export class HybridResearchService {
   ...
   */
  async conductResearch(query: string): Promise<HybridResearchResult> {
    try {
...
Based on your training data, provide insights about this company/topic including background, market position, and key considerations.`
  ...
  private async synthesizeFindings(
    ...
    try {
      ...
      const prompt = `You are an expert analyst. Synthesize the following research into actionable insights:
